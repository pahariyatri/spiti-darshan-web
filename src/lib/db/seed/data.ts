/**
 * Seed content: the approved 9-day Shimla → Spiti → Manali itinerary, transcribed from
 * reference/original.html (day articles, `routeDays` pins and `segmentDefs`).
 * Coordinates and descriptions are intentionally left empty rather than guessed.
 */
import type { StopType } from '../../domain/types';
...
export const attractions: SeedAttraction[] = [
...
export const shimlaToSpiti: SeedRoute = {
...
export const routes: SeedRoute[] = [shimlaToSpiti];
